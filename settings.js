...
global.owner = process.env.OWNER_NUMBER  || '94784198085' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=udUCCYRB#l4pi2xewFcOUd1IyzhrXeeMPlSoWE7mfjj1wneiysIk' ,
